...
<body>
    ...
    <nav id="linha">
        ...
        <a href="provas.php" style="font-weight: bold;">Questões</a>
    ...
    <main>
        ...
        <form action="provas.php">
            ...
            <div class="select_pai" id="select_prova_pai">
                ...
                &nbsp;&nbsp;
                <label for="quantidade"><b>Quantidade:</b><input type="number" name="quantidade" id="quantidade"></label>
                &nbsp;&nbsp;
        ...
        <a href="criar_provas.php" style="text-decoration:none; width: fit-content; height:fit-content;" id="rapidex">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $serie = $row['serie'];
            $materia = $row['materia'];
            echo  '<div class="container01" style="background-color:white;">';
            ...
            echo "<a href='editar_prova.php?id=$row[id]' title='Editar questão'><img src='../imagens/editar.svg' alt='editar'></a>";
